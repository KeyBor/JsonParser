...
//利用宏来简化null、false、true的检验
#define TEST_LITERAL(ret,json) \
do{\
    lept_value v;\
    v.type = LEPT_PARSE_INVALID_VALUE;\
    EXPECT_EQ_INT(LEPT_PARSE_OK, lept_parse(&v, json));\
    EXPECT_EQ_INT(ret, lept_get_type(&v));\
}while(0)
...
static void test_parse_invalid_value() {
    ...
    //用于检测原版代码的bug
    TEST_ERROR(LEPT_PARSE_INVALID_VALUE, "null3576");
